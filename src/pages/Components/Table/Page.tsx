		...
		<div className="flex flex-col gap-12">
			...
			<Preview title={"Style"} className="">
				<div className="flex flex-col space-y-4 items-center">
					Solid
					<div>
						<Table stickyHeader size={SizeEnum.Large} borderLess={BorderEnum.Solid}>
							<TableHead>
								<TableHeadCell>Header 1</TableHeadCell>
								<TableHeadCell>Header 2</TableHeadCell>
								<TableHeadCell>Header 3</TableHeadCell>
					...
					Dotted
					<div>
						<Table size={SizeEnum.Small} borderLess={BorderEnum.Dotted}>
							<TableHead>
								<TableHeadCell>Header 1</TableHeadCell>
								<TableHeadCell>Header 2</TableHeadCell>
								<TableHeadCell>Header 3</TableHeadCell>
					...
					Dashed
					<div>
						<Table size={SizeEnum.Small} borderLess={BorderEnum.Dashed}>
							<TableHead>
								<TableHeadCell>Header 1</TableHeadCell>
								<TableHeadCell>Header 2</TableHeadCell>
								<TableHeadCell>Header 3</TableHeadCell>
			...
			<Preview title="Example" className="flex flex-col items-center justify-center">
				<Table showHover  size={SizeEnum.Small}>
					<TableHead>
			...
			<Table showHover stickyHeader size={SizeEnum.Large}>
				<TableHead>
					<TableHeadCell data-first>AMOUNT</TableHeadCell>
					<TableHeadCell>DESCRIPTION</TableHeadCell>
					<TableHeadCell>CUSTOMER</TableHeadCell>
