...
import {ColorPickerAutocomplete} from './ColorPickerAutocomplete.tsx';
...
const getOptionLabel = (option: CountryType) => option.label;
...
const Page = () => {
  ...
  return (
    <div className='flex flex-col gap-12'>
      ...
      <Preview
        title='Custimized Listbox'
        className='flex justify-center'
      >
        <ColorPickerAutocomplete/>
      </Preview>
      <Preview
        title='States'
        className='grid grid-flow-col gap-5'
      >
        <Autocomplete {...defaultProps} disabled placeholder='disabled'/>
        <Autocomplete {...defaultProps} readOnly placeholder='readOnly'/>
      </Preview>
      <Preview
        title='Features'
      ...
      >
        ...
        {SIZING.map(size => (
          <Autocomplete
            ...
            multiple
            size={size}
            placeholder={'Multiple/' + SIZING_CONFIG[size].label}
          />
        ))}
      </Preview>
    </div>
